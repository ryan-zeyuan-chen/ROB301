...
For the purposes of this lab, the robot can be modeled as a “unicycle,” whose pose is given by three degrees of freedom: x, y and θ, as measured in a global reference frame. In short, **x** = [x,y,&theta]
